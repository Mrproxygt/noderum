...
// ── AnimatedShaderHero (exact structure from reference) ──────────
interface HeroProps {
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.15] pb-1 bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent animate-fade-in-up animation-delay-200">
              {headline.line1}
            </h1>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-[1.15] pb-2 bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent animate-fade-in-up animation-delay-400">
              {headline.line2}
            </h1>
          </div>
...
export function NoderumHero() {
  return (
    <AnimatedShaderHero
      trustBadge={{
        text: "Byggt för svenska företag.",
        icons: ["✦"],
      }}
      headline={{
        line1: "Bygger framtidens",
        line2: "AI-bolag.",
      }}
      subtitle="Vi driver inte projekt. Vi bygger bolag — från första kodraden till första miljonen i återkommande intäkter."
      buttons={{
        primary: {
          text: "Hör av dig",
