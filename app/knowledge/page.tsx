  ...
  return (
    <div className="bg-[#EFEFEF] min-h-screen pt-28 md:pt-36">
      <section className="max-w-[1440px] mx-auto px-5 sm:px-8 md:px-12 pb-16">
        ...
        <p className="text-[15px] sm:text-[16px] text-gray-600 max-w-[680px] leading-relaxed">Tankar om AI, venture building och svenska SMB — från operatörerna bakom bolagen.</p>
      </section>
