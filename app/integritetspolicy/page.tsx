...
export const metadata: Metadata = { title: "Integritetspolicy", description: "Så samlar Noderum in och använder personuppgifter.", alternates: { canonical: "/integritetspolicy" } }
